...
public class TelescopeStringPot extends CommandBase {
  ...
  public void initialize() {
    ...
    else if(state == Tower.TargetLevel.Chute)setpoint = Constants.EXTEND_CONE_CHUTE;
    else if(state == Tower.TargetLevel.Substation)setpoint = Constants.EXTEND_CONE_SUBSTATION;
