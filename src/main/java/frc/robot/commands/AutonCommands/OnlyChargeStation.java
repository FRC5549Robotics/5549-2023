...
public class OnlyChargeStation extends SequentialCommandGroup {
  /** Creates a new ZeroConeAuto. */
  DrivetrainSubsystem m_drivetrainSubsystem;
  PathPlannerTrajectory path;
  public OnlyChargeStation(DrivetrainSubsystem drivetrainSubsystem, PathPlannerTrajectory path) {
